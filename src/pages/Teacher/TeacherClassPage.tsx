          ...
          >
            ...
            {lecture.isLive && (
              <motion.div
                ...
                className="absolute -right-8 top-6 rotate-45 bg-gradient-to-r from-blue-400 to-blue-500 px-12 py-1 text-xs font-bold text-white shadow-lg"
              >
                LIVE
              </motion.div>
            )}
            ...
            <div className="p-6 sm:p-8">
              ...
              >
                ...
                <p className="text-sm text-blue-700">{lecture.notification}</p>
              </motion.div>
            </div>
          </motion.div>
        ))}
