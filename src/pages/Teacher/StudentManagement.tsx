      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex gap-4">
          <select
            ...
            className="p-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300"
          >
          ...
          <button
            ...
            className="bg-gray-600 text-white p-3 rounded-lg hover:bg-gray-700 transition duration-300"
          >
            Clear Grade Filter
          </button>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl p-6 hover:shadow-lg transition-shadow duration-300">
